...
- **Main Tasks:** Always try to reuse components, or create a shared component for better workflow and consistency
- **TODO:** Always update TODO-BACKLOG.md file with currect tasks to be completed before the start of every session. And update the status of those tasks after session.
- **Clarification:** Ask clarification questions before commiting or concluding anything.