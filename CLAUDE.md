...
# Version: 6.6 | Updated: March 25, 2026
...
## 18. SIDEBAR NAV — LOCKED v4.0 (March 25, 2026)

Section              Item                  Status
────────────────────────────────────────────────────────
(none)               Dashboard             ✅ KSS-SA-010 built (analytics merged here)
...
REMOVED PERMANENTLY: Analytics nav item — analytics is now the Dashboard page.
...
✅ KSS-SA-006   Analytics — DONE (March 25, 2026): merged into Dashboard
...
✅ KSS-SA-010   Dashboard — DONE (March 25, 2026):
               Analytics page merged into Dashboard. /super-admin/analytics redirects → /super-admin/dashboard.
               3 tabs: Platform Health | Revenue | Client Admins (no CSV export)
               Platform Health chart: DAU + New Sign-ups (Attempts series removed)
               Content tab removed entirely (ContentTab.tsx deleted, fetchContentAnalytics removed)
               Compliance group added to SA sidebar nav (Audit Log moved from Configuration)
               next.config.ts: permanent redirect /super-admin/analytics → /super-admin/dashboard
...
*CLAUDE.md — keySkillset v6.6 — Updated March 25, 2026*
