      ...
      <PageWrapper>
        <div className="max-w-3xl mx-auto flex flex-col gap-6 py-2">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <h1 className="text-xl font-bold text-[#1E3A5F]">{config.title}</h1>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-bold text-[#1E3A5F]">General Instructions</h2>
            </div>
            <ol className="text-sm text-gray-700 leading-relaxed space-y-3 list-decimal list-inside">
